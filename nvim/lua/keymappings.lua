...
local term_opts_np = { noremap = false}
...
-- Moving panels
keymap("n", "m", "<C-w>w", silent)

-- Open command mode
keymap("n", ";", ":", term_opts_np)

-- Save file by Exit Application 
-- keymap("", "<C-q>", ":q!<CR>", silent)
keymap("", "<leader>q", ":q!<CR>", silent)
...
keymap("n", "<C-n>", "<ESC> :NvimTreeToggle<CR>", silent)
